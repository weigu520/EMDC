...
public class Env implements Serializable{
    ...
    public Env(String srcId, String destId, String devId, String sensorId, Integer sensorCounter, String cmdType, DataType dataType, String data, Integer status, Long timestamp) {
        this.srcId = srcId;
        this.destId = destId;
        this.devId = devId;
